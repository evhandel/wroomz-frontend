    ...
    return (
        <div>
            ...
            <Table sx={{ minWidth: 1000 }} aria-label='customized table'>
                ...
                <TableBody>
                    <TableRow key={1} sx={{ backgroundColor: (theme) => theme.custom.tableRowAlt }}>
                    ...
                    <TableRow key={3} sx={{ backgroundColor: (theme) => theme.custom.tableRowAlt }}>
                    ...
                    <TableRow key="dsq">
                        <StyledTableCell align='center'>Disqualification</StyledTableCell>
                        {results.map((result) => (
                            <StyledTableCell key={result.teamNumber} align='center'>
